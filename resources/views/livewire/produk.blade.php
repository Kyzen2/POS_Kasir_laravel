<div class="container">
    <div class="row my-4">
        <div class="col-12 text-center">
            ...
            <button wire:loading class="col-lg-4 col-md-6 mb-4 btn btn-custom-orange mx-2 py-2 px-4 rounded-pill shadow-sm">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <p class="lead text-muted mb-1">
                <span style="color: red; font-size: 20px;">*</span> <i style="font-size: 15px;">Hanya Jabatan Pegawai Yang Dapat Menjadi Instruktur!!</i>
            </p>
